// components/dashboard/finance/PeriodSelector.tsx
                    ...
                    {tab === 'quick' ? (
                        ...
                        <div className="p-4 space-y-3">
                            <div>
                                ...
                                <input type="date" value={toInputDate(customStart)} onChange={e => setCustomStart(new Date(e.target.value))} className="w-full text-sm p-1.5 border border-gray-300 rounded-md"/>
                            </div>
                             <div>
                                <label className="text-xs font-medium text-gray-500">Até</label>
                                <input type="date" value={toInputDate(customEnd)} onChange={e => setCustomEnd(new Date(e.target.value))} className="w-full text-sm p-1.5 border border-gray-300 rounded-md"/>
                            </div>
